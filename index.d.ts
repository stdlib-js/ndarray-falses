...
* // returns 'bool'
*/
declare function falses( shape: Shape | number, options: BooleanOptions ): boolndarray;
...
* // returns 'generic'
*/
declare function falses( shape: Shape | number, options: GenericOptions ): genericndarray<boolean>;
...
* // returns 'bool'
*/
declare function falses( shape: Shape | number, options?: Options ): boolndarray;
...
* // returns 'bool'
*/
declare function falses( shape: Shape | number, options?: OptionsWithDType ): typedndarray<boolean>;
